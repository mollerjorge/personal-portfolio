...
const works = [
  {
    ...
    client:
      'Nobly is a point-of-sale, inventory management and CRM app for the iPad and android tablets. It offers a complete solution for coffee shops, restaurants and retail stores.',
    project:
  ...
  },
  {
    ...
    client:
      'Integra provides an all in one solution for contact centers through uContact, their main web based platform.',
    project:
      'uContact is a a web application that aims to reduce costs and improve the productivity of agents and supervisors within a contact center. Some of the features uContact has to offer are: Dialers (Inbound & Outbound) - SMS, Email & Webchat in a Unified Inbox - A Call Center Designed CRM - Completely Customizable Reporting - Gamification - Recording - Voice Broadcasting - Quality Control - Live Coaching (Spy, Whisper, Collaborate).',
    challenge:
  ...
  },
  {
    ...
    client: null,
    project:
      'Nova is an administrator template built by me that can be used by anyone to start up a project.',
    challenge:
